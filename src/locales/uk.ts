export default {
  ...
  projects: {
    ...
    developmentProcess: 'Процес розробки',
    developmentDescription: 'Цей проєкт був розроблений з використанням гнучкої методології, з акцентом на ітеративну розробку та постійний зворотний зв\'язок. Процес розробки включав:',
    requirementsGathering: 'Збір вимог та дослідження користувачів',
    wireframing: 'Створення прототипів та дизайн інтерфейсу',
    development: 'Розробка фронтенду та бекенду',
    testing: 'Тестування та забезпечення якості',
    deployment: 'Розгортання та моніторинг',
    results: 'Результати',
    projectOutcomes: 'Результати проєкту',
    outcomesDescription: 'Цей проєкт досяг значних результатів та позитивних наслідків для клієнта, включаючи:',
    userEngagement: 'Залучення користувачів',
    loadingTime: 'Час завантаження',
